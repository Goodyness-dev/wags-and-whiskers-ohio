...
export default function DashboardOverview({ onNavigateTab, onSelectQuote, onOpenNewOrder }) {
  ...
  // Care Visit Timer State (Like the Time Tracker widget in the reference)
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 font-medium mt-0.5">
            Plan, prioritize, and manage pet care requests and scheduled visits.
          </p>
        </div>
              ...
              >
                <div className="min-w-0 pr-2">
                  ...
                  <div className="text-[11px] text-slate-400 truncate">
                    {q.name} â€¢ {q.detailedService || q.serviceCategory}
                  </div>
                </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 bg-gradient-to-br from-slate-900 to-black text-white border border-slate-800 rounded-3xl p-6 shadow-lg flex flex-col justify-between">
          <div className="flex items-center justify-between text-xs font-bold text-slate-400 uppercase tracking-wider">
            ...
            <span className="text-emerald-400 font-mono text-[11px]">â— ACTIVE</span>
          </div>
