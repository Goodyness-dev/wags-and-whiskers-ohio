      ...
      >
        ...
        <div className="px-6 py-5 border-b border-slate-200 flex flex-wrap items-center justify-between gap-4 bg-white">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <h2 className="text-xl sm:text-2xl font-black font-heading text-slate-900 mt-0.5">
                {quote.name} â€” {quote.make} {quote.modelAndYear}
              </h2>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2.5">
            ...
            >
              <option value="pending">â³ Pending (Needs Quote)</option>
              <option value="in_review">ðŸ” In Review</option>
              <option value="quoted">ðŸ“§ Quoted (Sent to Customer)</option>
              <option value="completed">âœ… Completed Repair</option>
        ...
        <div className="flex border-b border-slate-200 px-6 bg-white">
          ...
          >
            ...
            <span>{quote.make ? 'Full Pet(s) & Issue Specs' : 'Full Service & Issue Specs'}</span>
          </button>
        </div>
              ...
              {quote.quotedPrice && (
                <div className="p-4 rounded-2xl bg-blue-50 border border-blue-200 flex items-start space-x-3 text-xs sm:text-sm text-blue-800 shadow-xs">
                  ...
                  <div>
                    ...
                    <div>Price: <strong className="text-blue-900 font-mono">${quote.quotedPrice}</strong> â€¢ Turnaround: {quote.estimatedTurnaround || 'N/A'}</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-white border border-slate-200/80 rounded-2xl p-5 space-y-3 shadow-xs">
                  <span className="text-xs font-bold text-slate-400 uppercase tracking-wider block">
                    {quote.make ? 'Pet(s) Specifications' : 'Service & Property Details'}
                  </span>
                  {quote.make ? (
                    <>
